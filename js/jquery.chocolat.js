	...
	$.fn.Chocolat = function(settings) {
		...
		this.each(function(index){
			...
			$(this).each(function() {
				...
				images[settings.setIndex][index]['id'] = isSet($(this).attr('rev'), ' ');
		...
		function upadteDescription(){
			...
			$('#Choco_container_title').html(images[settings.setIndex][settings.currentImage]['caption']+' (<a href="http://flickr.com/photos/'+settings.user+'/'+images[settings.setIndex][settings.currentImage]['id']+'/lightbox/" target="_blank" class="ViewOnFlickr"> View on flickr</a>)');
